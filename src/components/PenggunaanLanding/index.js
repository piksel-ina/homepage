...
export default function PenggunaanLanding() {
  ...
  const sections = [
    {
      ...
      href: "/penggunaan/ketahanan-pangan",
    ...
    },
    {
      ...
      href: "/penggunaan/kebencanaan/banjir",
    ...
    },
    {
      ...
      href: "/penggunaan/penggunaan-lahan",
    ...
    },
    {
      ...
      href: "/penggunaan/pemantauan-lingkungan",
    ...
    },
    {
      ...
      href: "/penggunaan/pengelolaan-pesisir",
  ...
  return (
    <div className={styles.container}>
              ...
              <div className={styles.imageContainer}>
                {imageErrors[section.id] ? (
                  <div className={styles.imageFallback}>
                    ...
                    <span className={styles.fallbackTitle}>{section.title}</span>
      ...
      {/* Tombol Scroll to Top - Updated dengan SVG dan Teks */}
      {showScrollTop && (
        <button 
          onClick={scrollToTop}
